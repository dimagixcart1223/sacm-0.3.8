...
CObjectPool::CObjectPool()
{
	...
	for(SACMOBJECT byteObjectID = 0; byteObjectID != MAX_OBJECTS; byteObjectID++) {
...
SACMOBJECT CObjectPool::New(int iModel, VECTOR * vecPos, VECTOR * vecRot)
{
	SACMOBJECT byteObjectID;
...
SACMOBJECT CObjectPool::New(int iPlayer, int iModel, VECTOR* vecPos, VECTOR* vecRot)
{
	BYTE byteObjectID;
...
void CObjectPool::Process(float fElapsedTime)
{
	...
	for (SACMPLAYER i = 0; i < MAX_PLAYERS; i++)
	{
		...
		{
			for (SACMOBJECT j = 0; j < MAX_OBJECTS; j++)
			{
	...
	for (SACMOBJECT i = 0; i < MAX_OBJECTS; i++)
	{
...
BOOL CObjectPool::Delete(SACMOBJECT byteObjectID)
{
...
BOOL CObjectPool::DeleteForPlayer(SACMPLAYER bytePlayerID, SACMOBJECT byteObjectID)
{
...
void CObjectPool::InitForPlayer(SACMPLAYER bytePlayerID)
{	
