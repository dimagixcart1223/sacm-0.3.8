...
{	
	...
	//Font tuned up :D @CentiuS
	D3DXCreateFontA(m_pD3DDevice, iFontSize, 0, FW_BOLD, 0, FALSE,
		DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_NATURAL_QUALITY, DEFAULT_PITCH, "Arial", &m_pD3DFont);
}
