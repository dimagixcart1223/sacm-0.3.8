...
public:
	...
	void Say(char * szText);

	void SetID(SACMPLAYER playerId) { m_PlayerID = playerId; };
	SACMPLAYER GetID() { return m_PlayerID; };
	...
	void EnterVehicle(SACMVEHICLE VehicleID, BOOL bPassenger);
	void ExitVehicle();
