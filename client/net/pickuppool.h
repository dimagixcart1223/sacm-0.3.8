...
public:
	...
	void New(int iModel, float fX, float fY, float fZ, DWORD dwAmmo, SACMPLAYER DeadPlayer = INVALID_PLAYER_ID);
	void New(PICKUP* pPickup, int iPickup);
	void Destroy(int iPickup);
	void DestroyDropped(SACMPLAYER playerId);
